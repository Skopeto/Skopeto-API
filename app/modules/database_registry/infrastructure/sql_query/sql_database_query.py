...
def create_database_health_query(database_health: DatabaseHealth) -> tuple[str, dict[str, Any]]:
    query = """
    ...
    params = {
        ...
        'checked_at': database_health.checked_at.replace(tzinfo=None) if database_health.checked_at else None
    }
    return query, params
...
def update_database_health_query(database_health: DatabaseHealth) -> tuple[str, dict[str, Any]]:
    query = """
