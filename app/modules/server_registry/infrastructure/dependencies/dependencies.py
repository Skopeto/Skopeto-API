...
from app.modules.server_registry.application.service.shell_service import ServerShellService, ServerShellServiceInterface
...
def get_shell_service(
    ssh_client: SSHClientInterface = Depends(get_ssh_client)
) -> ServerShellServiceInterface:
    return ServerShellService(ssh_client)